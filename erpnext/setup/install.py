...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via Smartbits ERP</div>"""
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "Smartbits ERP")
